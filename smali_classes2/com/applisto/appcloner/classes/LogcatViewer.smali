...
.method private showLogs()V
    ...
    .line 161
    .local v7, "intentVerbose":Landroid/content/Intent;
    const-string v8, "V"
    ...
    .line 165
    .local v8, "pendingIntentVerbose":Landroid/app/PendingIntent;
    new-instance v9, Landroid/content/Intent;

    invoke-direct {v9, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 166
    .local v9, "intentDebug":Landroid/content/Intent;
    const-string v10, "D"

    invoke-virtual {v9, v0, v10}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    .line 167
    iget-object v10, p0, Lcom/applisto/appcloner/classes/LogcatViewer;->mContext:Landroid/content/Context;
    ...
    invoke-static {v10, v11, v9, v6}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v10

    .line 170
    .local v10, "pendingIntentDebug":Landroid/app/PendingIntent;
    ...
    .line 175
    .local v0, "pendingIntentInfo":Landroid/app/PendingIntent;
    ...
    .line 178
    invoke-virtual {v12, v11}, Landroid/app/Notification$Builder;->setPriority(I)Landroid/app/Notification$Builder;

    move-result-object v11

    .line 179
    invoke-virtual {v11, v6}, Landroid/app/Notification$Builder;->setAutoCancel(Z)Landroid/app/Notification$Builder;

    move-result-object v11

    .line 180
    .local v11, "builder":Landroid/app/Notification$Builder;
    invoke-static {v11}, Lcom/applisto/appcloner/classes/Utils;->setSmallNotificationIcon(Landroid/app/Notification$Builder;)V
    ...
    invoke-virtual {v11, v12}, Landroid/app/Notification$Builder;->setChannelId(Ljava/lang/String;)Landroid/app/Notification$Builder;
    ...
    invoke-virtual {v11, v12}, Landroid/app/Notification$Builder;->addAction(Landroid/app/Notification$Action;)Landroid/app/Notification$Builder;
    ...
    .line 193
    iget v12, v6, Landroid/app/Notification;->defaults:I
    ...
    invoke-virtual {v2, v12, v6}, Landroid/app/NotificationManager;->notify(ILandroid/app/Notification;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 198
    .end local v0    # "pendingIntentInfo":Landroid/app/PendingIntent;
    ...
    .end local v7    # "intentVerbose":Landroid/content/Intent;
    .end local v8    # "pendingIntentVerbose":Landroid/app/PendingIntent;
    .end local v9    # "intentDebug":Landroid/content/Intent;
    .end local v10    # "pendingIntentDebug":Landroid/app/PendingIntent;
