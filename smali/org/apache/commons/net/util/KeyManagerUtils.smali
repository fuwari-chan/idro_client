...
.method public static createClientKeyManager(Ljava/security/KeyStore;Ljava/lang/String;Ljava/lang/String;)Ljavax/net/ssl/KeyManager;
    ...
    new-instance v0, Lorg/apache/commons/net/util/KeyManagerUtils$X509KeyManager;

    invoke-direct {v0, p0}, Lorg/apache/commons/net/util/KeyManagerUtils$X509KeyManager;-><init>(Lorg/apache/commons/net/util/KeyManagerUtils$ClientKeyStore;)V
...
.method private static findAlias(Ljava/security/KeyStore;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v3}, Ljava/security/KeyStore;->isKeyEntry(Ljava/lang/String;)Z
