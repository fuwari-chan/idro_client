...
.method private createFileEntryParser(Ljava/lang/String;Lorg/apache/commons/net/ftp/FTPClientConfig;)Lorg/apache/commons/net/ftp/FTPFileEntryParser;
    ...
    const-string v2, " does not implement the interface org.apache.commons.net.ftp.FTPFileEntryParser."
    ...
    invoke-direct {v0, v1, v5}, Lorg/apache/commons/net/ftp/parser/ParserInitializationException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    const-string v1, "Error initializing parser"
    ...
    invoke-direct {v3, p2}, Lorg/apache/commons/net/ftp/parser/UnixFTPEntryParser;-><init>(Lorg/apache/commons/net/ftp/FTPClientConfig;)V
    ...
    new-instance v3, Lorg/apache/commons/net/ftp/parser/VMSVersioningFTPEntryParser;

    invoke-direct {v3, p2}, Lorg/apache/commons/net/ftp/parser/VMSVersioningFTPEntryParser;-><init>(Lorg/apache/commons/net/ftp/FTPClientConfig;)V
    ...
    new-instance v3, Lorg/apache/commons/net/ftp/parser/OS2FTPEntryParser;

    invoke-direct {v3, p2}, Lorg/apache/commons/net/ftp/parser/OS2FTPEntryParser;-><init>(Lorg/apache/commons/net/ftp/FTPClientConfig;)V
    ...
    new-instance v3, Lorg/apache/commons/net/ftp/parser/MVSFTPEntryParser;

    invoke-direct {v3}, Lorg/apache/commons/net/ftp/parser/MVSFTPEntryParser;-><init>()V
    ...
    new-instance v3, Lorg/apache/commons/net/ftp/parser/NetwareFTPEntryParser;

    invoke-direct {v3, p2}, Lorg/apache/commons/net/ftp/parser/NetwareFTPEntryParser;-><init>(Lorg/apache/commons/net/ftp/FTPClientConfig;)V

    goto :goto_1

    :cond_8
    const-string v0, "MACOS PETER"
    ...
    new-instance v3, Lorg/apache/commons/net/ftp/parser/MacOsPeterFTPEntryParser;

    invoke-direct {v3, p2}, Lorg/apache/commons/net/ftp/parser/MacOsPeterFTPEntryParser;-><init>(Lorg/apache/commons/net/ftp/FTPClientConfig;)V

    goto :goto_1

    :cond_9
    const-string v0, "TYPE: L8"
    ...
    :cond_b
    :goto_1
    instance-of v0, v3, Lorg/apache/commons/net/ftp/Configurable;
...
.method public createFileEntryParser(Lorg/apache/commons/net/ftp/FTPClientConfig;)Lorg/apache/commons/net/ftp/FTPFileEntryParser;
    ...
    invoke-direct {p0, v1, p1}, Lorg/apache/commons/net/ftp/parser/DefaultFTPFileEntryParserFactory;->createFileEntryParser(Ljava/lang/String;Lorg/apache/commons/net/ftp/FTPClientConfig;)Lorg/apache/commons/net/ftp/FTPFileEntryParser;
