...
.method private __initDefaults()V
    ...
    iput-object v0, p0, Lorg/apache/commons/net/ftp/FTPClient;->__featuresMap:Ljava/util/HashMap;
...
.method private __mergeListeners(Lorg/apache/commons/net/io/CopyStreamListener;)Lorg/apache/commons/net/io/CopyStreamListener;
    ...
    :cond_1
    new-instance v1, Lorg/apache/commons/net/io/CopyStreamAdapter;

    invoke-direct {v1}, Lorg/apache/commons/net/io/CopyStreamAdapter;-><init>()V

    invoke-virtual {v1, p1}, Lorg/apache/commons/net/io/CopyStreamAdapter;->addCopyStreamListener(Lorg/apache/commons/net/io/CopyStreamListener;)V

    iget-object v0, p0, Lorg/apache/commons/net/ftp/FTPClient;->__copyStreamListener:Lorg/apache/commons/net/io/CopyStreamListener;

    invoke-virtual {v1, v0}, Lorg/apache/commons/net/io/CopyStreamAdapter;->addCopyStreamListener(Lorg/apache/commons/net/io/CopyStreamListener;)V

    return-object v1
.end method

.method private static __parsePathname(Ljava/lang/String;)Ljava/lang/String;
    .locals 5
...
.method private getDefaultedBufferSize()I
    .locals 1
...
.method private initiateListParsing(Lorg/apache/commons/net/ftp/FTPFileEntryParser;Ljava/lang/String;)Lorg/apache/commons/net/ftp/FTPListParseEngine;
    ...
    invoke-virtual {p0, v1, v0}, Lorg/apache/commons/net/ftp/FTPClient;->_openDataConnection_(ILjava/lang/String;)Ljava/net/Socket;
    ...
    invoke-virtual {p1, v0, v1}, Lorg/apache/commons/net/ftp/FTPListParseEngine;->readServerList(Ljava/io/InputStream;Ljava/lang/String;)V
    :try_end_0
...
.method private initiateMListParsing(Ljava/lang/String;)Lorg/apache/commons/net/ftp/FTPListParseEngine;
    ...
    new-instance v2, Lorg/apache/commons/net/ftp/FTPListParseEngine;
    ...
    invoke-direct {v2, v0}, Lorg/apache/commons/net/ftp/FTPListParseEngine;-><init>(Lorg/apache/commons/net/ftp/FTPFileEntryParser;)V
    ...
    invoke-virtual {v2, v0, v1}, Lorg/apache/commons/net/ftp/FTPListParseEngine;->readServerList(Ljava/io/InputStream;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected _connectAction_()V
    ...
    iget v5, p0, Lorg/apache/commons/net/ftp/FTPClient;->_replyCode:I

    const-string v0, "UTF8"

    invoke-virtual {p0, v0}, Lorg/apache/commons/net/ftp/FTPClient;->hasFeature(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, Lorg/apache/commons/net/ftp/FTPClient;->setControlEncoding(Ljava/lang/String;)V

    new-instance v0, Lorg/apache/commons/net/io/CRLFLineReader;

    new-instance v1, Ljava/io/InputStreamReader;

    iget-object v2, p0, Lorg/apache/commons/net/ftp/FTPClient;->_input_:Ljava/io/InputStream;
    ...
    iput-object v0, p0, Lorg/apache/commons/net/ftp/FTPClient;->_controlInput_:Ljava/io/BufferedReader;

    new-instance v0, Ljava/io/BufferedWriter;

    new-instance v1, Ljava/io/OutputStreamWriter;

    iget-object v2, p0, Lorg/apache/commons/net/ftp/FTPClient;->_output_:Ljava/io/OutputStream;
    ...
    iput-object v0, p0, Lorg/apache/commons/net/ftp/FTPClient;->_controlOutput_:Ljava/io/BufferedWriter;
    ...
    iput v5, p0, Lorg/apache/commons/net/ftp/FTPClient;->_replyCode:I
...
.method protected _openDataConnection_(Ljava/lang/String;Ljava/lang/String;)Ljava/net/Socket;
    ...
    invoke-virtual {v0, v1, v3, v2}, Ljavax/net/ServerSocketFactory;->createServerSocket(IILjava/net/InetAddress;)Ljava/net/ServerSocket;
    ...
    invoke-virtual {p0, v0, v1}, Lorg/apache/commons/net/ftp/FTPClient;->eprt(Ljava/net/InetAddress;I)I
    ...
    invoke-virtual {p0, v0, v1}, Lorg/apache/commons/net/ftp/FTPClient;->port(Ljava/net/InetAddress;I)I
    ...
    invoke-virtual {p0, v0, v1}, Lorg/apache/commons/net/ftp/FTPClient;->restart(J)Z
    ...
    iget-object v1, p0, Lorg/apache/commons/net/ftp/FTPClient;->__passiveLocalHost:Ljava/net/InetAddress;
    ...
    iget v2, p0, Lorg/apache/commons/net/ftp/FTPClient;->__passivePort:I

    invoke-direct {v0, v1, v2}, Ljava/net/InetSocketAddress;-><init>(Ljava/lang/String;I)V

    iget v1, p0, Lorg/apache/commons/net/ftp/FTPClient;->connectTimeout:I
    ...
    invoke-virtual {p0, v4}, Lorg/apache/commons/net/ftp/FTPClient;->verifyRemote(Ljava/net/Socket;)Z
...
.method protected _parseExtendedPassiveModeReply(Ljava/lang/String;)V
    ...
    iput v3, p0, Lorg/apache/commons/net/ftp/FTPClient;->__passivePort:I
...
.method protected _parsePassiveModeReply(Ljava/lang/String;)V
    ...
    const-string v1, "[Replacing site local address "
    ...
    invoke-virtual {p0, v1, v0}, Lorg/apache/commons/net/ftp/FTPClient;->fireReplyReceived(ILjava/lang/String;)V

    iput-object v3, p0, Lorg/apache/commons/net/ftp/FTPClient;->__passiveHost:Ljava/lang/String;
    :try_end_1
...
.method protected _retrieveFile(Ljava/lang/String;Ljava/lang/String;Ljava/io/OutputStream;)Z
    ...
    invoke-direct {p0}, Lorg/apache/commons/net/ftp/FTPClient;->getDefaultedBufferSize()I
    ...
    iget v2, p0, Lorg/apache/commons/net/ftp/FTPClient;->__controlKeepAliveReplyTimeout:I

    invoke-direct {v7, p0, v0, v1, v2}, Lorg/apache/commons/net/ftp/FTPClient$CSL;-><init>(Lorg/apache/commons/net/ftp/FTPClient;JI)V
...
.method public getSystemType()Ljava/lang/String;
    ...
    iput-object v3, p0, Lorg/apache/commons/net/ftp/FTPClient;->__systemName:Ljava/lang/String;
