...
.field private final items:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<Ljava/lang/String;TI;>;"
        }
    .end annotation
.end field
...
.method public static create()Lorg/apache/http/config/RegistryBuilder;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<I:Ljava/lang/Object;>()Lorg/apache/http/config/RegistryBuilder<TI;>;"
        }
    .end annotation
...
.method public final build()Lorg/apache/http/config/Registry;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()Lorg/apache/http/config/Registry<TI;>;"
        }
    .end annotation
...
.method public final register(Ljava/lang/String;Ljava/lang/Object;)Lorg/apache/http/config/RegistryBuilder;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Ljava/lang/String;TI;)Lorg/apache/http/config/RegistryBuilder<TI;>;"
        }
    .end annotation
