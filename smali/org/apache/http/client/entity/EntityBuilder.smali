...
.method public build()Lorg/apache/http/HttpEntity;
    ...
    invoke-direct {p0, v1}, Lorg/apache/http/client/entity/EntityBuilder;->getContentOrDefault(Lorg/apache/http/entity/ContentType;)Lorg/apache/http/entity/ContentType;

    move-result-object v1

    invoke-direct {v4, v0, v1}, Lorg/apache/http/entity/StringEntity;-><init>(Ljava/lang/String;Lorg/apache/http/entity/ContentType;)V
    ...
    invoke-direct {v4, v0, v1}, Lorg/apache/http/entity/ByteArrayEntity;-><init>([BLorg/apache/http/entity/ContentType;)V
    ...
    invoke-direct {v4, v0, v2, v3, v1}, Lorg/apache/http/entity/InputStreamEntity;-><init>(Ljava/io/InputStream;JLorg/apache/http/entity/ContentType;)V
    ...
    :goto_0
    invoke-direct {v4, v0, v1}, Lorg/apache/http/client/entity/UrlEncodedFormEntity;-><init>(Ljava/lang/Iterable;Ljava/nio/charset/Charset;)V
    ...
    new-instance v4, Lorg/apache/http/entity/SerializableEntity;

    iget-object v0, p0, Lorg/apache/http/client/entity/EntityBuilder;->serializable:Ljava/io/Serializable;

    invoke-direct {v4, v0}, Lorg/apache/http/entity/SerializableEntity;-><init>(Ljava/io/Serializable;)V
    ...
    invoke-virtual {v4, v0}, Lorg/apache/http/entity/AbstractHttpEntity;->setContentType(Ljava/lang/String;)V
    ...
    invoke-direct {v4, v0, v1}, Lorg/apache/http/entity/FileEntity;-><init>(Ljava/io/File;Lorg/apache/http/entity/ContentType;)V
    ...
    :goto_1
    invoke-virtual {v4}, Lorg/apache/http/entity/AbstractHttpEntity;->getContentType()Lorg/apache/http/Header;
    ...
    invoke-virtual {v4, v0}, Lorg/apache/http/entity/AbstractHttpEntity;->setContentEncoding(Ljava/lang/String;)V

    iget-boolean v0, p0, Lorg/apache/http/client/entity/EntityBuilder;->chunked:Z

    invoke-virtual {v4, v0}, Lorg/apache/http/entity/AbstractHttpEntity;->setChunked(Z)V
    ...
    invoke-direct {v0, v4}, Lorg/apache/http/client/entity/GzipCompressingEntity;-><init>(Lorg/apache/http/HttpEntity;)V
...
.method public setParameters(Ljava/util/List;)Lorg/apache/http/client/entity/EntityBuilder;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Ljava/util/List<Lorg/apache/http/NameValuePair;>;)Lorg/apache/http/client/entity/EntityBuilder;"
        }
    .end annotation
