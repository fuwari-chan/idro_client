...
.field private authSchemeRegistry:Lorg/apache/http/config/Lookup;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lorg/apache/http/config/Lookup<Lorg/apache/http/auth/AuthSchemeProvider;>;"
        }
    .end annotation
.end field
...
.field private closeables:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<Ljava/io/Closeable;>;"
        }
    .end annotation
.end field
...
.field private contentDecoderMap:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<Ljava/lang/String;Lorg/apache/http/client/entity/InputStreamFactory;>;"
        }
    .end annotation
.end field
...
.field private defaultHeaders:Ljava/util/Collection;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Collection<+Lorg/apache/http/Header;>;"
        }
    .end annotation
.end field
...
.method public build()Lorg/apache/http/impl/client/CloseableHttpClient;
    ...
    iget-object v10, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->publicSuffixMatcher:Lorg/apache/http/conn/util/PublicSuffixMatcher;
    ...
    iget-object v11, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->requestExec:Lorg/apache/http/protocol/HttpRequestExecutor;

    if-nez v11, :cond_1

    new-instance v11, Lorg/apache/http/protocol/HttpRequestExecutor;

    invoke-direct {v11}, Lorg/apache/http/protocol/HttpRequestExecutor;-><init>()V

    :cond_1
    move-object/from16 v0, p0

    iget-object v12, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->connManager:Lorg/apache/http/conn/HttpClientConnectionManager;

    if-nez v12, :cond_e

    move-object/from16 v0, p0

    iget-object v13, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->sslSocketFactory:Lorg/apache/http/conn/socket/LayeredConnectionSocketFactory;

    if-nez v13, :cond_7

    move-object/from16 v0, p0

    iget-boolean v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->systemProperties:Z
    ...
    new-instance v16, Lorg/apache/http/conn/ssl/DefaultHostnameVerifier;

    move-object/from16 v0, v16

    invoke-direct {v0, v10}, Lorg/apache/http/conn/ssl/DefaultHostnameVerifier;-><init>(Lorg/apache/http/conn/util/PublicSuffixMatcher;)V

    :cond_4
    move-object/from16 v0, p0

    iget-object v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->sslContext:Ljavax/net/ssl/SSLContext;

    if-eqz v0, :cond_5

    new-instance v13, Lorg/apache/http/conn/ssl/SSLConnectionSocketFactory;
    ...
    invoke-direct {v13, v0, v14, v15, v1}, Lorg/apache/http/conn/ssl/SSLConnectionSocketFactory;-><init>(Ljavax/net/ssl/SSLContext;[Ljava/lang/String;[Ljava/lang/String;Ljavax/net/ssl/HostnameVerifier;)V
    ...
    invoke-direct {v13, v0, v14, v15, v1}, Lorg/apache/http/conn/ssl/SSLConnectionSocketFactory;-><init>(Ljavax/net/ssl/SSLSocketFactory;[Ljava/lang/String;[Ljava/lang/String;Ljavax/net/ssl/HostnameVerifier;)V
    ...
    invoke-direct {v13, v0, v1}, Lorg/apache/http/conn/ssl/SSLConnectionSocketFactory;-><init>(Ljavax/net/ssl/SSLContext;Ljavax/net/ssl/HostnameVerifier;)V

    :cond_7
    :goto_2
    new-instance v14, Lorg/apache/http/impl/conn/PoolingHttpClientConnectionManager;
    ...
    invoke-virtual {v1, v2, v3}, Lorg/apache/http/config/RegistryBuilder;->register(Ljava/lang/String;Ljava/lang/Object;)Lorg/apache/http/config/RegistryBuilder;

    move-result-object v1

    const-string v2, "https"

    invoke-virtual {v1, v2, v13}, Lorg/apache/http/config/RegistryBuilder;->register(Ljava/lang/String;Ljava/lang/Object;)Lorg/apache/http/config/RegistryBuilder;
    ...
    iget-object v4, v2, Lorg/apache/http/impl/client/HttpClientBuilder;->dnsResolver:Lorg/apache/http/conn/DnsResolver;

    move-object/from16 v2, p0

    iget-wide v5, v2, Lorg/apache/http/impl/client/HttpClientBuilder;->connTimeToLive:J

    move-object/from16 v2, p0

    iget-object v2, v2, Lorg/apache/http/impl/client/HttpClientBuilder;->connTimeToLiveTimeUnit:Ljava/util/concurrent/TimeUnit;

    if-eqz v2, :cond_8

    move-object/from16 v2, p0

    iget-object v7, v2, Lorg/apache/http/impl/client/HttpClientBuilder;->connTimeToLiveTimeUnit:Ljava/util/concurrent/TimeUnit;
    ...
    iget-object v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->defaultSocketConfig:Lorg/apache/http/config/SocketConfig;
    ...
    invoke-virtual {v14, v0}, Lorg/apache/http/impl/conn/PoolingHttpClientConnectionManager;->setDefaultSocketConfig(Lorg/apache/http/config/SocketConfig;)V

    :cond_9
    move-object/from16 v0, p0

    iget-object v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->defaultConnectionConfig:Lorg/apache/http/config/ConnectionConfig;
    ...
    invoke-virtual {v14, v0}, Lorg/apache/http/impl/conn/PoolingHttpClientConnectionManager;->setDefaultConnectionConfig(Lorg/apache/http/config/ConnectionConfig;)V
    ...
    invoke-virtual {v14, v0}, Lorg/apache/http/impl/conn/PoolingHttpClientConnectionManager;->setDefaultMaxPerRoute(I)V

    mul-int/lit8 v0, v16, 0x2

    invoke-virtual {v14, v0}, Lorg/apache/http/impl/conn/PoolingHttpClientConnectionManager;->setMaxTotal(I)V

    :cond_b
    move-object/from16 v0, p0

    iget v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->maxConnTotal:I
    ...
    iget v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->maxConnPerRoute:I
    ...
    iget-object v13, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->reuseStrategy:Lorg/apache/http/ConnectionReuseStrategy;
    ...
    sget-object v13, Lorg/apache/http/impl/NoConnectionReuseStrategy;->INSTANCE:Lorg/apache/http/impl/NoConnectionReuseStrategy;

    goto :goto_4

    :cond_f
    sget-object v13, Lorg/apache/http/impl/client/DefaultClientConnectionReuseStrategy;->INSTANCE:Lorg/apache/http/impl/client/DefaultClientConnectionReuseStrategy;

    :cond_10
    :goto_4
    move-object/from16 v0, p0

    iget-object v14, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->keepAliveStrategy:Lorg/apache/http/conn/ConnectionKeepAliveStrategy;

    if-nez v14, :cond_11

    sget-object v14, Lorg/apache/http/impl/client/DefaultConnectionKeepAliveStrategy;->INSTANCE:Lorg/apache/http/impl/client/DefaultConnectionKeepAliveStrategy;

    :cond_11
    move-object/from16 v0, p0

    iget-object v15, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->targetAuthStrategy:Lorg/apache/http/client/AuthenticationStrategy;

    if-nez v15, :cond_12

    sget-object v15, Lorg/apache/http/impl/client/TargetAuthenticationStrategy;->INSTANCE:Lorg/apache/http/impl/client/TargetAuthenticationStrategy;

    :cond_12
    move-object/from16 v0, p0

    iget-object v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->proxyAuthStrategy:Lorg/apache/http/client/AuthenticationStrategy;

    move-object/from16 v16, v0

    if-nez v16, :cond_13

    sget-object v16, Lorg/apache/http/impl/client/ProxyAuthenticationStrategy;->INSTANCE:Lorg/apache/http/impl/client/ProxyAuthenticationStrategy;

    :cond_13
    move-object/from16 v0, p0

    iget-object v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->userTokenHandler:Lorg/apache/http/client/UserTokenHandler;
    ...
    iget-boolean v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->connectionStateDisabled:Z

    if-nez v0, :cond_14

    sget-object v17, Lorg/apache/http/impl/client/DefaultUserTokenHandler;->INSTANCE:Lorg/apache/http/impl/client/DefaultUserTokenHandler;

    goto :goto_5

    :cond_14
    sget-object v17, Lorg/apache/http/impl/client/NoopUserTokenHandler;->INSTANCE:Lorg/apache/http/impl/client/NoopUserTokenHandler;
    ...
    invoke-direct {v7, v8}, Lorg/apache/http/protocol/RequestUserAgent;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v11}, Lorg/apache/http/impl/client/HttpClientBuilder;->decorateMainExec(Lorg/apache/http/impl/execchain/ClientExecChain;)Lorg/apache/http/impl/execchain/ClientExecChain;

    move-result-object v11

    move-object/from16 v0, p0

    iget-object v13, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->httpprocessor:Lorg/apache/http/protocol/HttpProcessor;
    ...
    iget-object v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->requestFirst:Ljava/util/LinkedList;
    ...
    invoke-virtual {v13, v15}, Lorg/apache/http/protocol/HttpProcessorBuilder;->addFirst(Lorg/apache/http/HttpRequestInterceptor;)Lorg/apache/http/protocol/HttpProcessorBuilder;
    ...
    iget-object v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->responseFirst:Ljava/util/LinkedList;
    ...
    invoke-virtual {v13, v15}, Lorg/apache/http/protocol/HttpProcessorBuilder;->addFirst(Lorg/apache/http/HttpResponseInterceptor;)Lorg/apache/http/protocol/HttpProcessorBuilder;
    ...
    iget-object v2, v2, Lorg/apache/http/impl/client/HttpClientBuilder;->defaultHeaders:Ljava/util/Collection;

    invoke-direct {v1, v2}, Lorg/apache/http/client/protocol/RequestDefaultHeaders;-><init>(Ljava/util/Collection;)V
    ...
    invoke-direct {v1, v2}, Lorg/apache/http/protocol/RequestUserAgent;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v13, v0}, Lorg/apache/http/protocol/HttpProcessorBuilder;->addAll([Lorg/apache/http/HttpRequestInterceptor;)Lorg/apache/http/protocol/HttpProcessorBuilder;

    move-object/from16 v0, p0

    iget-boolean v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->cookieManagementDisabled:Z
    ...
    invoke-virtual {v13, v0}, Lorg/apache/http/protocol/HttpProcessorBuilder;->add(Lorg/apache/http/HttpRequestInterceptor;)Lorg/apache/http/protocol/HttpProcessorBuilder;

    :cond_1a
    move-object/from16 v0, p0

    iget-boolean v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->contentCompressionDisabled:Z

    if-nez v0, :cond_1c

    move-object/from16 v0, p0

    iget-object v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->contentDecoderMap:Ljava/util/Map;
    ...
    invoke-direct {v0, v14}, Lorg/apache/http/client/protocol/RequestAcceptEncoding;-><init>(Ljava/util/List;)V
    ...
    iget-boolean v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->authCachingDisabled:Z
    ...
    invoke-virtual {v13, v0}, Lorg/apache/http/protocol/HttpProcessorBuilder;->add(Lorg/apache/http/HttpResponseInterceptor;)Lorg/apache/http/protocol/HttpProcessorBuilder;
    ...
    invoke-virtual {v14, v0, v1}, Lorg/apache/http/config/RegistryBuilder;->register(Ljava/lang/String;Ljava/lang/Object;)Lorg/apache/http/config/RegistryBuilder;
    ...
    invoke-virtual {v14}, Lorg/apache/http/config/RegistryBuilder;->build()Lorg/apache/http/config/Registry;
    ...
    iget-object v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->requestLast:Ljava/util/LinkedList;
    ...
    invoke-virtual {v13, v15}, Lorg/apache/http/protocol/HttpProcessorBuilder;->addLast(Lorg/apache/http/HttpRequestInterceptor;)Lorg/apache/http/protocol/HttpProcessorBuilder;
    ...
    iget-object v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->responseLast:Ljava/util/LinkedList;
    ...
    invoke-virtual {v13, v15}, Lorg/apache/http/protocol/HttpProcessorBuilder;->addLast(Lorg/apache/http/HttpResponseInterceptor;)Lorg/apache/http/protocol/HttpProcessorBuilder;

    goto :goto_c

    :cond_23
    invoke-virtual {v13}, Lorg/apache/http/protocol/HttpProcessorBuilder;->build()Lorg/apache/http/protocol/HttpProcessor;

    move-result-object v13

    :cond_24
    new-instance v0, Lorg/apache/http/impl/execchain/ProtocolExec;

    invoke-direct {v0, v11, v13}, Lorg/apache/http/impl/execchain/ProtocolExec;-><init>(Lorg/apache/http/impl/execchain/ClientExecChain;Lorg/apache/http/protocol/HttpProcessor;)V

    move-object v11, v0

    move-object/from16 v0, p0

    invoke-virtual {v0, v11}, Lorg/apache/http/impl/client/HttpClientBuilder;->decorateProtocolExec(Lorg/apache/http/impl/execchain/ClientExecChain;)Lorg/apache/http/impl/execchain/ClientExecChain;

    move-result-object v11

    move-object/from16 v0, p0

    iget-boolean v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->automaticRetriesDisabled:Z

    if-nez v0, :cond_26

    move-object/from16 v0, p0

    iget-object v13, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->retryHandler:Lorg/apache/http/client/HttpRequestRetryHandler;

    if-nez v13, :cond_25

    sget-object v13, Lorg/apache/http/impl/client/DefaultHttpRequestRetryHandler;->INSTANCE:Lorg/apache/http/impl/client/DefaultHttpRequestRetryHandler;

    :cond_25
    new-instance v0, Lorg/apache/http/impl/execchain/RetryExec;

    invoke-direct {v0, v11, v13}, Lorg/apache/http/impl/execchain/RetryExec;-><init>(Lorg/apache/http/impl/execchain/ClientExecChain;Lorg/apache/http/client/HttpRequestRetryHandler;)V
    ...
    iget-object v13, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->routePlanner:Lorg/apache/http/conn/routing/HttpRoutePlanner;

    if-nez v13, :cond_2a

    move-object/from16 v0, p0

    iget-object v14, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->schemePortResolver:Lorg/apache/http/conn/SchemePortResolver;

    if-nez v14, :cond_27

    sget-object v14, Lorg/apache/http/impl/conn/DefaultSchemePortResolver;->INSTANCE:Lorg/apache/http/impl/conn/DefaultSchemePortResolver;

    :cond_27
    move-object/from16 v0, p0

    iget-object v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->proxy:Lorg/apache/http/HttpHost;

    if-eqz v0, :cond_28

    new-instance v13, Lorg/apache/http/impl/conn/DefaultProxyRoutePlanner;

    move-object/from16 v0, p0

    iget-object v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->proxy:Lorg/apache/http/HttpHost;

    invoke-direct {v13, v0, v14}, Lorg/apache/http/impl/conn/DefaultProxyRoutePlanner;-><init>(Lorg/apache/http/HttpHost;Lorg/apache/http/conn/SchemePortResolver;)V
    ...
    new-instance v13, Lorg/apache/http/impl/conn/SystemDefaultRoutePlanner;

    invoke-static {}, Ljava/net/ProxySelector;->getDefault()Ljava/net/ProxySelector;

    move-result-object v0

    invoke-direct {v13, v14, v0}, Lorg/apache/http/impl/conn/SystemDefaultRoutePlanner;-><init>(Lorg/apache/http/conn/SchemePortResolver;Ljava/net/ProxySelector;)V

    goto :goto_d

    :cond_29
    new-instance v13, Lorg/apache/http/impl/conn/DefaultRoutePlanner;

    invoke-direct {v13, v14}, Lorg/apache/http/impl/conn/DefaultRoutePlanner;-><init>(Lorg/apache/http/conn/SchemePortResolver;)V

    :cond_2a
    :goto_d
    move-object/from16 v0, p0

    iget-object v14, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->serviceUnavailStrategy:Lorg/apache/http/client/ServiceUnavailableRetryStrategy;

    if-eqz v14, :cond_2b

    new-instance v0, Lorg/apache/http/impl/execchain/ServiceUnavailableRetryExec;

    invoke-direct {v0, v11, v14}, Lorg/apache/http/impl/execchain/ServiceUnavailableRetryExec;-><init>(Lorg/apache/http/impl/execchain/ClientExecChain;Lorg/apache/http/client/ServiceUnavailableRetryStrategy;)V
    ...
    iget-boolean v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->redirectHandlingDisabled:Z

    if-nez v0, :cond_2d

    move-object/from16 v0, p0

    iget-object v15, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->redirectStrategy:Lorg/apache/http/client/RedirectStrategy;

    if-nez v15, :cond_2c

    sget-object v15, Lorg/apache/http/impl/client/DefaultRedirectStrategy;->INSTANCE:Lorg/apache/http/impl/client/DefaultRedirectStrategy;

    :cond_2c
    new-instance v0, Lorg/apache/http/impl/execchain/RedirectExec;

    invoke-direct {v0, v11, v13, v15}, Lorg/apache/http/impl/execchain/RedirectExec;-><init>(Lorg/apache/http/impl/execchain/ClientExecChain;Lorg/apache/http/conn/routing/HttpRoutePlanner;Lorg/apache/http/client/RedirectStrategy;)V
    ...
    new-instance v0, Lorg/apache/http/impl/execchain/BackoffStrategyExec;

    move-object/from16 v1, p0

    iget-object v1, v1, Lorg/apache/http/impl/client/HttpClientBuilder;->connectionBackoffStrategy:Lorg/apache/http/client/ConnectionBackoffStrategy;

    move-object/from16 v2, p0

    iget-object v2, v2, Lorg/apache/http/impl/client/HttpClientBuilder;->backoffManager:Lorg/apache/http/client/BackoffManager;

    invoke-direct {v0, v11, v1, v2}, Lorg/apache/http/impl/execchain/BackoffStrategyExec;-><init>(Lorg/apache/http/impl/execchain/ClientExecChain;Lorg/apache/http/client/ConnectionBackoffStrategy;Lorg/apache/http/client/BackoffManager;)V
    ...
    iget-object v15, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->authSchemeRegistry:Lorg/apache/http/config/Lookup;
    ...
    iget-object v10, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->cookieStore:Lorg/apache/http/client/CookieStore;
    ...
    iget-object v14, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->credentialsProvider:Lorg/apache/http/client/CredentialsProvider;
    ...
    new-instance v14, Lorg/apache/http/impl/client/SystemDefaultCredentialsProvider;

    invoke-direct {v14}, Lorg/apache/http/impl/client/SystemDefaultCredentialsProvider;-><init>()V

    goto :goto_e

    :cond_32
    new-instance v14, Lorg/apache/http/impl/client/BasicCredentialsProvider;

    invoke-direct {v14}, Lorg/apache/http/impl/client/BasicCredentialsProvider;-><init>()V

    :cond_33
    :goto_e
    move-object/from16 v0, p0

    iget-object v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->closeables:Ljava/util/List;
    ...
    iget-boolean v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->connManagerShared:Z
    ...
    iget-boolean v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->evictExpiredConnections:Z

    if-nez v0, :cond_36

    move-object/from16 v0, p0

    iget-boolean v0, v0, Lorg/apache/http/impl/client/HttpClientBuilder;->evictIdleConnections:Z

    if-eqz v0, :cond_39

    :cond_36
    new-instance v19, Lorg/apache/http/impl/client/IdleConnectionEvictor;

    move-object/from16 v1, v18

    move-object/from16 v2, p0

    iget-wide v2, v2, Lorg/apache/http/impl/client/HttpClientBuilder;->maxIdleTime:J
    ...
    iget-object v4, v4, Lorg/apache/http/impl/client/HttpClientBuilder;->maxIdleTimeUnit:Ljava/util/concurrent/TimeUnit;
    ...
    iget-wide v5, v5, Lorg/apache/http/impl/client/HttpClientBuilder;->maxIdleTime:J

    move-object/from16 v7, p0

    iget-object v7, v7, Lorg/apache/http/impl/client/HttpClientBuilder;->maxIdleTimeUnit:Ljava/util/concurrent/TimeUnit;

    move-object/from16 v0, v19

    invoke-direct/range {v0 .. v7}, Lorg/apache/http/impl/client/IdleConnectionEvictor;-><init>(Lorg/apache/http/conn/HttpClientConnectionManager;JLjava/util/concurrent/TimeUnit;JLjava/util/concurrent/TimeUnit;)V

    new-instance v0, Lorg/apache/http/impl/client/HttpClientBuilder$1;

    move-object/from16 v1, p0

    move-object/from16 v2, v19

    invoke-direct {v0, v1, v2}, Lorg/apache/http/impl/client/HttpClientBuilder$1;-><init>(Lorg/apache/http/impl/client/HttpClientBuilder;Lorg/apache/http/impl/client/IdleConnectionEvictor;)V
    ...
    invoke-virtual {v0}, Lorg/apache/http/impl/client/IdleConnectionEvictor;->start()V

    :cond_39
    new-instance v0, Lorg/apache/http/impl/client/HttpClientBuilder$2;

    move-object/from16 v1, p0

    move-object/from16 v2, v18

    invoke-direct {v0, v1, v2}, Lorg/apache/http/impl/client/HttpClientBuilder$2;-><init>(Lorg/apache/http/impl/client/HttpClientBuilder;Lorg/apache/http/conn/HttpClientConnectionManager;)V
    ...
    iget-object v8, v8, Lorg/apache/http/impl/client/HttpClientBuilder;->defaultRequestConfig:Lorg/apache/http/client/config/RequestConfig;
...
.method public final setDefaultAuthSchemeRegistry(Lorg/apache/http/config/Lookup;)Lorg/apache/http/impl/client/HttpClientBuilder;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lorg/apache/http/config/Lookup<Lorg/apache/http/auth/AuthSchemeProvider;>;)Lorg/apache/http/impl/client/HttpClientBuilder;"
        }
    .end annotation
...
.method public final setDefaultCookieSpecRegistry(Lorg/apache/http/config/Lookup;)Lorg/apache/http/impl/client/HttpClientBuilder;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lorg/apache/http/config/Lookup<Lorg/apache/http/cookie/CookieSpecProvider;>;)Lorg/apache/http/impl/client/HttpClientBuilder;"
        }
    .end annotation
