...
.field private final connPerRoute:Lorg/apache/http/pool/ConnPoolControl;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lorg/apache/http/pool/ConnPoolControl<Lorg/apache/http/conn/routing/HttpRoute;>;"
        }
    .end annotation
.end field
...
.field private final lastRouteBackoffs:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<Lorg/apache/http/conn/routing/HttpRoute;Ljava/lang/Long;>;"
        }
    .end annotation
.end field
...
.method public constructor <init>(Lorg/apache/http/pool/ConnPoolControl;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lorg/apache/http/pool/ConnPoolControl<Lorg/apache/http/conn/routing/HttpRoute;>;)V"
        }
    .end annotation
...
.method constructor <init>(Lorg/apache/http/pool/ConnPoolControl;Lorg/apache/http/impl/client/Clock;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lorg/apache/http/pool/ConnPoolControl<Lorg/apache/http/conn/routing/HttpRoute;>;Lorg/apache/http/impl/client/Clock;)V"
        }
    .end annotation
...
.method private getLastUpdate(Ljava/util/Map;Lorg/apache/http/conn/routing/HttpRoute;)Ljava/lang/Long;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Ljava/util/Map<Lorg/apache/http/conn/routing/HttpRoute;Ljava/lang/Long;>;Lorg/apache/http/conn/routing/HttpRoute;)Ljava/lang/Long;"
        }
    .end annotation
...
.method public backOff(Lorg/apache/http/conn/routing/HttpRoute;)V
    ...
    iget-object v0, p0, Lorg/apache/http/impl/client/AIMDBackoffManager;->clock:Lorg/apache/http/impl/client/Clock;

    invoke-interface {v0}, Lorg/apache/http/impl/client/Clock;->getCurrentTime()J
    ...
    iget-wide v2, p0, Lorg/apache/http/impl/client/AIMDBackoffManager;->coolDown:J
    ...
    invoke-direct {p0, v5}, Lorg/apache/http/impl/client/AIMDBackoffManager;->getBackedOffPoolSize(I)I

    move-result v1

    invoke-interface {v0, p1, v1}, Lorg/apache/http/pool/ConnPoolControl;->setMaxPerRoute(Ljava/lang/Object;I)V
...
.method public probe(Lorg/apache/http/conn/routing/HttpRoute;)V
    ...
    invoke-interface {v0, p1, v5}, Lorg/apache/http/pool/ConnPoolControl;->setMaxPerRoute(Ljava/lang/Object;I)V
