...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "Ljava/lang/Object;Lorg/apache/http/HttpConnectionFactory<Lorg/apache/http/impl/DefaultBHttpServerConnection;>;"
    }
.end annotation
...
.field private final requestParserFactory:Lorg/apache/http/io/HttpMessageParserFactory;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lorg/apache/http/io/HttpMessageParserFactory<Lorg/apache/http/HttpRequest;>;"
        }
    .end annotation
.end field
...
.field private final responseWriterFactory:Lorg/apache/http/io/HttpMessageWriterFactory;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lorg/apache/http/io/HttpMessageWriterFactory<Lorg/apache/http/HttpResponse;>;"
        }
    .end annotation
.end field
...
.method public constructor <init>(Lorg/apache/http/config/ConnectionConfig;Lorg/apache/http/entity/ContentLengthStrategy;Lorg/apache/http/entity/ContentLengthStrategy;Lorg/apache/http/io/HttpMessageParserFactory;Lorg/apache/http/io/HttpMessageWriterFactory;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lorg/apache/http/config/ConnectionConfig;Lorg/apache/http/entity/ContentLengthStrategy;Lorg/apache/http/entity/ContentLengthStrategy;Lorg/apache/http/io/HttpMessageParserFactory<Lorg/apache/http/HttpRequest;>;Lorg/apache/http/io/HttpMessageWriterFactory<Lorg/apache/http/HttpResponse;>;)V"
        }
    .end annotation
    ...
    :goto_0
    iput-object v0, p0, Lorg/apache/http/impl/DefaultBHttpServerConnectionFactory;->cconfig:Lorg/apache/http/config/ConnectionConfig;
...
.method public constructor <init>(Lorg/apache/http/config/ConnectionConfig;Lorg/apache/http/io/HttpMessageParserFactory;Lorg/apache/http/io/HttpMessageWriterFactory;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lorg/apache/http/config/ConnectionConfig;Lorg/apache/http/io/HttpMessageParserFactory<Lorg/apache/http/HttpRequest;>;Lorg/apache/http/io/HttpMessageWriterFactory<Lorg/apache/http/HttpResponse;>;)V"
        }
    .end annotation
...
.method public createConnection(Ljava/net/Socket;)Lorg/apache/http/impl/DefaultBHttpServerConnection;
    ...
    new-instance v10, Lorg/apache/http/impl/DefaultBHttpServerConnection;
