...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "Ljava/lang/Object;Ljava/io/Closeable;Lorg/apache/http/conn/HttpClientConnectionManager;Lorg/apache/http/pool/ConnPoolControl<Lorg/apache/http/conn/routing/HttpRoute;>;"
    }
.end annotation
...
.method public constructor <init>(Lorg/apache/http/config/Registry;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lorg/apache/http/config/Registry<Lorg/apache/http/conn/socket/ConnectionSocketFactory;>;)V"
        }
    .end annotation
    ...
    invoke-direct {p0, p1, v0, v1}, Lorg/apache/http/impl/conn/PoolingHttpClientConnectionManager;-><init>(Lorg/apache/http/config/Registry;Lorg/apache/http/conn/HttpConnectionFactory;Lorg/apache/http/conn/DnsResolver;)V
...
.method public constructor <init>(Lorg/apache/http/config/Registry;Lorg/apache/http/conn/DnsResolver;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lorg/apache/http/config/Registry<Lorg/apache/http/conn/socket/ConnectionSocketFactory;>;Lorg/apache/http/conn/DnsResolver;)V"
        }
    .end annotation
...
.method public constructor <init>(Lorg/apache/http/config/Registry;Lorg/apache/http/conn/HttpConnectionFactory;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lorg/apache/http/config/Registry<Lorg/apache/http/conn/socket/ConnectionSocketFactory;>;Lorg/apache/http/conn/HttpConnectionFactory<Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/conn/ManagedHttpClientConnection;>;)V"
        }
    .end annotation
...
.method public constructor <init>(Lorg/apache/http/config/Registry;Lorg/apache/http/conn/HttpConnectionFactory;Lorg/apache/http/conn/DnsResolver;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lorg/apache/http/config/Registry<Lorg/apache/http/conn/socket/ConnectionSocketFactory;>;Lorg/apache/http/conn/HttpConnectionFactory<Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/conn/ManagedHttpClientConnection;>;Lorg/apache/http/conn/DnsResolver;)V"
        }
    .end annotation
...
.method public constructor <init>(Lorg/apache/http/conn/HttpClientConnectionOperator;Lorg/apache/http/conn/HttpConnectionFactory;JLjava/util/concurrent/TimeUnit;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lorg/apache/http/conn/HttpClientConnectionOperator;Lorg/apache/http/conn/HttpConnectionFactory<Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/conn/ManagedHttpClientConnection;>;JLjava/util/concurrent/TimeUnit;)V"
        }
    .end annotation
...
.method public constructor <init>(Lorg/apache/http/conn/HttpConnectionFactory;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lorg/apache/http/conn/HttpConnectionFactory<Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/conn/ManagedHttpClientConnection;>;)V"
        }
    .end annotation
...
.method constructor <init>(Lorg/apache/http/impl/conn/CPool;Lorg/apache/http/config/Lookup;Lorg/apache/http/conn/SchemePortResolver;Lorg/apache/http/conn/DnsResolver;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lorg/apache/http/impl/conn/CPool;Lorg/apache/http/config/Lookup<Lorg/apache/http/conn/socket/ConnectionSocketFactory;>;Lorg/apache/http/conn/SchemePortResolver;Lorg/apache/http/conn/DnsResolver;)V"
        }
    .end annotation
...
.method private formatStats(Lorg/apache/http/conn/routing/HttpRoute;)Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lorg/apache/http/pool/PoolStats;->getAvailable()I
    ...
    const-string v0, "route allocated: "
    ...
    invoke-virtual {v4}, Lorg/apache/http/pool/PoolStats;->getLeased()I
    ...
    invoke-virtual {v4}, Lorg/apache/http/pool/PoolStats;->getMax()I
...
.method public connect(Lorg/apache/http/HttpClientConnection;Lorg/apache/http/conn/routing/HttpRoute;ILorg/apache/http/protocol/HttpContext;)V
    ...
    invoke-direct {p0, v7}, Lorg/apache/http/impl/conn/PoolingHttpClientConnectionManager;->resolveSocketConfig(Lorg/apache/http/HttpHost;)Lorg/apache/http/config/SocketConfig;
...
.method public getRoutes()Ljava/util/Set;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()Ljava/util/Set<Lorg/apache/http/conn/routing/HttpRoute;>;"
        }
    .end annotation
...
.method protected leaseConnection(Ljava/util/concurrent/Future;JLjava/util/concurrent/TimeUnit;)Lorg/apache/http/HttpClientConnection;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Ljava/util/concurrent/Future<Lorg/apache/http/impl/conn/CPoolEntry;>;JLjava/util/concurrent/TimeUnit;)Lorg/apache/http/HttpClientConnection;"
        }
    .end annotation
    ...
    const-string v2, "Connection leased: "
...
.method public releaseConnection(Lorg/apache/http/HttpClientConnection;Ljava/lang/Object;JLjava/util/concurrent/TimeUnit;)V
    ...
    :goto_0
    invoke-virtual {p1, p2}, Lorg/apache/http/impl/conn/CPoolEntry;->setState(Ljava/lang/Object;)V

    invoke-virtual {p1, p3, p4, p5}, Lorg/apache/http/impl/conn/CPoolEntry;->updateExpiry(JLjava/util/concurrent/TimeUnit;)V
    ...
    invoke-direct {p0, p1}, Lorg/apache/http/impl/conn/PoolingHttpClientConnectionManager;->format(Lorg/apache/http/impl/conn/CPoolEntry;)Ljava/lang/String;
    ...
    const-string v2, " can be kept alive "
    ...
    invoke-interface {v6, v0}, Lorg/apache/http/conn/ManagedHttpClientConnection;->setSocketTimeout(I)V
    :try_end_2
    ...
    invoke-virtual {p1}, Lorg/apache/http/impl/conn/CPoolEntry;->isRouteComplete()Z
    ...
    :goto_2
    invoke-virtual {v0, p1, v1}, Lorg/apache/http/impl/conn/CPool;->release(Lorg/apache/http/pool/PoolEntry;Z)V
...
.method public shutdown()V
    ...
    const-string v1, "I/O exception shutting down connection manager"
...
.method public upgrade(Lorg/apache/http/HttpClientConnection;Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/protocol/HttpContext;)V
    ...
    invoke-interface {v0, p1, v1, p3}, Lorg/apache/http/conn/HttpClientConnectionOperator;->upgrade(Lorg/apache/http/conn/ManagedHttpClientConnection;Lorg/apache/http/HttpHost;Lorg/apache/http/protocol/HttpContext;)V
