...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/SwipeRefreshLayout;->setNestedScrollingEnabled(Z)V
...
.method private finishSpinner(F)V
    ...
    new-instance p1, Landroid/support/v4/widget/SwipeRefreshLayout$5;

    invoke-direct {p1, p0}, Landroid/support/v4/widget/SwipeRefreshLayout$5;-><init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V

    :cond_1
    iget v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->mCurrentTargetOffsetTop:I

    invoke-direct {p0, v0, p1}, Landroid/support/v4/widget/SwipeRefreshLayout;->animateOffsetToStartPosition(ILandroid/view/animation/Animation$AnimationListener;)V
...
.method private moveSpinner(F)V
    ...
    :cond_0
    iget v9, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->mSpinnerFinalOffset:F
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->mAlphaStartAnimation:Landroid/view/animation/Animation;

    invoke-direct {p0, v0}, Landroid/support/v4/widget/SwipeRefreshLayout;->isAnimationRunning(Landroid/view/animation/Animation;)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->mAlphaMaxAnimation:Landroid/view/animation/Animation;
    ...
    invoke-virtual {v0, v2, v1}, Landroid/support/v4/widget/MaterialProgressDrawable;->setStartEndTrim(FF)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/MaterialProgressDrawable;->setProgressRotation(F)V
...
.method private startAlphaAnimation(II)Landroid/view/animation/Animation;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/CircleImageView;->startAnimation(Landroid/view/animation/Animation;)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, Landroid/support/v4/widget/SwipeRefreshLayout;->mNestedScrollInProgress:Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/CircleImageView;->getMeasuredWidth()I
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Landroid/support/v4/widget/CircleImageView;->layout(IIII)V
...
.method public onNestedPreScroll(Landroid/view/View;II[I)V
    ...
    invoke-virtual {p0, v0, v1, p1, v2}, Landroid/support/v4/widget/SwipeRefreshLayout;->dispatchNestedPreScroll(II[I[I)Z
