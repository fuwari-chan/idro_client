...
.method private handleQueueTask(Landroid/support/v4/app/NotificationManagerCompat$Task;)V
    ...
    iget-object v0, v2, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;->taskQueue:Ljava/util/LinkedList;
...
.method private processListenerQueue(Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;)V
    ...
    invoke-interface {v2, v0}, Landroid/support/v4/app/NotificationManagerCompat$Task;->send(Landroid/support/v4/app/INotificationSideChannel;)V
...
.method private updateListenerMap()V
    ...
    const-string v1, "Permission present on component "
    ...
    const-string v1, ", not adding listener record."
    ...
    const-string v1, "Adding listener record for "
    ...
    new-instance v1, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;

    invoke-direct {v1, v6}, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager$ListenerRecord;-><init>(Landroid/content/ComponentName;)V
    ...
    const-string v1, "Removing listener record for "
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    iget-object v1, p1, Landroid/support/v4/app/NotificationManagerCompat$ServiceConnectedEvent;->iBinder:Landroid/os/IBinder;

    invoke-direct {p0, v0, v1}, Landroid/support/v4/app/NotificationManagerCompat$SideChannelManager;->handleServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
