...
.method public final hideFragment(Landroid/support/v4/app/Fragment;II)V
    ...
    invoke-direct {p0, v0, p2}, Landroid/support/v4/app/FragmentManagerImpl;->setHWLayerAnimListenerIfAlpha(Landroid/view/View;Landroid/view/animation/Animation;)V
...
.method final moveToState(IIIZ)V
    ...
    iget-object v0, v7, Landroid/support/v4/app/Fragment;->mLoaderManager:Landroid/support/v4/app/LoaderManagerImpl;
...
.method final moveToState(Landroid/support/v4/app/Fragment;IIIZ)V
    ...
    invoke-direct {p0, v0, p3}, Landroid/support/v4/app/FragmentManagerImpl;->setHWLayerAnimListenerIfAlpha(Landroid/view/View;Landroid/view/animation/Animation;)V
    ...
    invoke-direct {v0, p0, p4, v6, p3}, Landroid/support/v4/app/FragmentManagerImpl$5;-><init>(Landroid/support/v4/app/FragmentManagerImpl;Landroid/view/View;Landroid/view/animation/Animation;Landroid/support/v4/app/Fragment;)V
...
.method final popBackStackState(Landroid/os/Handler;Ljava/lang/String;II)Z
    ...
    invoke-virtual {v2, p2, p1}, Landroid/support/v4/app/BackStackRecord;->calculateBackFragments(Landroid/util/SparseArray;Landroid/util/SparseArray;)V

    const/4 v0, 0x1

    const/4 v1, 0x0

    invoke-virtual {v2, v0, v1, p2, p1}, Landroid/support/v4/app/BackStackRecord;->popFromBackStack(ZLandroid/support/v4/app/BackStackRecord$TransitionState;Landroid/util/SparseArray;Landroid/util/SparseArray;)Landroid/support/v4/app/BackStackRecord$TransitionState;
    ...
    iget v0, v2, Landroid/support/v4/app/BackStackRecord;->mIndex:I
    ...
    invoke-virtual {v0, p1, p3}, Landroid/support/v4/app/BackStackRecord;->calculateBackFragments(Landroid/util/SparseArray;Landroid/util/SparseArray;)V
    ...
    :goto_5
    invoke-virtual {v0, v1, p4, p1, p3}, Landroid/support/v4/app/BackStackRecord;->popFromBackStack(ZLandroid/support/v4/app/BackStackRecord$TransitionState;Landroid/util/SparseArray;Landroid/util/SparseArray;)Landroid/support/v4/app/BackStackRecord$TransitionState;
...
.method final restoreAllState(Landroid/os/Parcelable;Ljava/util/List;)V
    ...
    iput-object v0, v4, Landroid/support/v4/app/Fragment;->mSavedFragmentState:Landroid/os/Bundle;
    ...
    invoke-virtual {v4, v0, v1}, Landroid/support/v4/app/FragmentState;->instantiate(Landroid/support/v4/app/FragmentHostCallback;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    iget v1, v4, Landroid/support/v4/app/BackStackRecord;->mIndex:I
    ...
    invoke-direct {v5, v0}, Landroid/support/v4/util/LogWriter;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v0, p2, v1}, Landroid/support/v4/app/BackStackRecord;->dump(Ljava/lang/String;Ljava/io/PrintWriter;Z)V
