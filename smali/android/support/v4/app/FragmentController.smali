...
.method private constructor <init>(Landroid/support/v4/app/FragmentHostCallback;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Landroid/support/v4/app/FragmentHostCallback<*>;)V"
        }
    .end annotation
...
.method public getActiveFragments(Ljava/util/List;)Ljava/util/List;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Ljava/util/List<Landroid/support/v4/app/Fragment;>;)Ljava/util/List<Landroid/support/v4/app/Fragment;>;"
        }
    .end annotation
...
.method public getActiveFragmentsCount()I
    ...
    iget-object v1, v0, Landroid/support/v4/app/FragmentManagerImpl;->mActive:Ljava/util/ArrayList;
...
.method public restoreAllState(Landroid/os/Parcelable;Ljava/util/List;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Landroid/os/Parcelable;Ljava/util/List<Landroid/support/v4/app/Fragment;>;)V"
        }
    .end annotation
...
.method public restoreLoaderNonConfig(Landroid/support/v4/util/SimpleArrayMap;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Landroid/support/v4/util/SimpleArrayMap<Ljava/lang/String;Landroid/support/v4/app/LoaderManager;>;)V"
        }
    .end annotation
