...
// shuffle packets
	...
	packet(0x0202,6,clif->pTickSend,2);
	packet(0x0361,2,clif->pSearchStoreInfoNextPage,0);
	packet(0x07E4,6,clif->pSolveCharName,2);
	packet(0x0815,36,clif->pStoragePassword,0);
	packet(0x0819,90,clif->pUseSkillToPosMoreInfo,2,4,6,8,10);
	packet(0x0838,-1,clif->pReqOpenBuyingStore,2,4,8,9,89);
	packet(0x085D,12,clif->pSearchStoreInfoListItemClick,2,6,10);
	packet(0x0863,5,clif->pWalkToXY,2);
	packet(0x0878,26,clif->pFriendsListAdd,2);
	packet(0x087E,-1,clif->pReqTradeBuyingStore,2,4,8,12);
	packet(0x0884,-1,clif->pItemListWindowSelected,2,4,8,12);
	//packet(0x0896,4,NULL,0); // CZ_GANGSI_RANK
	packet(0x0897,-1,clif->pSearchStoreInfo,2,4,5,9,13,14,15);
	packet(0x08A2,10,clif->pUseSkillToId,2,4,6);
	packet(0x08A9,5,clif->pHomMenu,2,4);
	packet(0x08AD,6,clif->pGetCharNameRequest,2);
	packet(0x091D,2,clif->pReqCloseBuyingStore,0);
	packet(0x091F,5,clif->pChangeDir,2,4);
	packet(0x0940,6,clif->pReqClickBuyingStore,2);
	packet(0x0941,8,clif->pMoveToKafra,2,4);
	packet(0x0945,6,clif->pTakeItem,2);
	//packet(0x0947,8,NULL,0); // CZ_JOIN_BATTLE_FIELD
	packet(0x0949,19,clif->pWantToConnection,2,6,10,14,18);
	packet(0x094E,26,clif->pPartyInvite2,2);
	packet(0x0958,18,clif->pPartyBookingRegisterReq,2,4);
	packet(0x095A,8,clif->pMoveFromKafra,2,4);
	packet(0x0963,7,clif->pActionRequest,2,6);
	packet(0x0965,6,clif->pDropItem,2,4);
	packet(0x0967,10,clif->pUseSkillToPos,2,4,6,8);
#endif
// 2017-11-15aRagexeRE
#if PACKETVER == 20171115
	packet(0x035F,6,clif->pTickSend,2);
	packet(0x0360,19,clif->pWantToConnection,2,6,10,14,18);
	packet(0x0365,6,clif->pDropItem,2,4);
	packet(0x0366,90,clif->pUseSkillToPosMoreInfo,2,4,6,8,10);
	packet(0x0368,6,clif->pSolveCharName,2);
	packet(0x0369,7,clif->pActionRequest,2,6);
	...
	packet(0x0437,5,clif->pWalkToXY,2);
	packet(0x0438,10,clif->pUseSkillToPos,2,4,6,8);
	packet(0x0802,26,clif->pFriendsListAdd,2);
	packet(0x0811,-1,clif->pReqTradeBuyingStore,2,4,8,12);
	packet(0x0815,-1,clif->pReqOpenBuyingStore,2,4,8,9,89);
	packet(0x0817,2,clif->pReqCloseBuyingStore,0);
	packet(0x0819,-1,clif->pSearchStoreInfo,2,4,5,9,13,14,15);
	...
	packet(0x0838,12,clif->pSearchStoreInfoListItemClick,2,6,10);
	packet(0x083C,10,clif->pUseSkillToId,2,4,6);
	//packet(0x086D,4,NULL,0); // CZ_GANGSI_RANK
	packet(0x086F,-1,clif->pItemListWindowSelected,2,4,8,12);
	packet(0x087E,8,clif->pMoveFromKafra,2,4);
	//packet(0x0883,8,NULL,0); // CZ_JOIN_BATTLE_FIELD
	packet(0x088B,8,clif->pMoveToKafra,2,4);
	packet(0x0890,18,clif->pPartyBookingRegisterReq,2,4);
	packet(0x0898,36,clif->pStoragePassword,0);
	packet(0x08A4,5,clif->pChangeDir,2,4);
	packet(0x0926,6,clif->pTakeItem,2);
	packet(0x0958,5,clif->pHomMenu,2,4);
	packet(0x095A,26,clif->pPartyInvite2,2);
	packet(0x096A,6,clif->pGetCharNameRequest,2);
#endif
// 2017-11-22bRagexeRE
#if PACKETVER == 20171122
	packet(0x0281,6,clif->pSolveCharName,2);
	packet(0x02C4,-1,clif->pSearchStoreInfo,2,4,5,9,13,14,15);
	//packet(0x035F,4,NULL,0); // CZ_GANGSI_RANK
	packet(0x0838,8,clif->pMoveToKafra,2,4);
	packet(0x083C,5,clif->pHomMenu,2,4);
	packet(0x085B,6,clif->pGetCharNameRequest,2);
	packet(0x0862,-1,clif->pItemListWindowSelected,2,4,8,12);
	packet(0x0867,19,clif->pWantToConnection,2,6,10,14,18);
	packet(0x0877,-1,clif->pReqTradeBuyingStore,2,4,8,12);
	//packet(0x0885,8,NULL,0); // CZ_JOIN_BATTLE_FIELD
	packet(0x0890,6,clif->pTickSend,2);
	packet(0x0891,6,clif->pTakeItem,2);
	packet(0x0893,12,clif->pSearchStoreInfoListItemClick,2,6,10);
	packet(0x0897,5,clif->pChangeDir,2,4);
	packet(0x0898,6,clif->pDropItem,2,4);
	packet(0x089A,8,clif->pMoveFromKafra,2,4);
	packet(0x089E,7,clif->pActionRequest,2,6);
	packet(0x08A6,10,clif->pUseSkillToPos,2,4,6,8);
	packet(0x08A9,6,clif->pReqClickBuyingStore,2);
	packet(0x091E,90,clif->pUseSkillToPosMoreInfo,2,4,6,8,10);
	packet(0x0920,2,clif->pReqCloseBuyingStore,0);
	packet(0x0923,18,clif->pPartyBookingRegisterReq,2,4);
	packet(0x0934,36,clif->pStoragePassword,0);
	packet(0x093B,10,clif->pUseSkillToId,2,4,6);
	packet(0x0945,2,clif->pSearchStoreInfoNextPage,0);
	packet(0x0946,26,clif->pFriendsListAdd,2);
	packet(0x0947,5,clif->pWalkToXY,2);
	packet(0x0962,26,clif->pPartyInvite2,2);
	packet(0x0968,-1,clif->pReqOpenBuyingStore,2,4,8,9,89);
#endif
// 2017-11-29aRagexeRE
#if PACKETVER == 20171129
	packet(0x02C4,5,clif->pChangeDir,2,4);
	packet(0x035F,6,clif->pReqClickBuyingStore,2);
	packet(0x0361,12,clif->pSearchStoreInfoListItemClick,2,6,10);
	packet(0x0363,26,clif->pFriendsListAdd,2);
	packet(0x0365,6,clif->pDropItem,2,4);
	packet(0x0366,90,clif->pUseSkillToPosMoreInfo,2,4,6,8,10);
	packet(0x0368,6,clif->pSolveCharName,2);
	packet(0x0369,7,clif->pActionRequest,2,6);
	...
	packet(0x0819,-1,clif->pSearchStoreInfo,2,4,5,9,13,14,15);
	packet(0x0835,2,clif->pSearchStoreInfoNextPage,0);
	packet(0x0838,26,clif->pPartyInvite2,2);
	packet(0x083C,10,clif->pUseSkillToId,2,4,6);
	packet(0x0862,6,clif->pTakeItem,2);
	packet(0x086D,18,clif->pPartyBookingRegisterReq,2,4);
	//packet(0x0876,4,NULL,0); // CZ_GANGSI_RANK
	packet(0x0878,36,clif->pStoragePassword,0);
	packet(0x088A,-1,clif->pItemListWindowSelected,2,4,8,12);
	packet(0x089C,5,clif->pHomMenu,2,4);
	packet(0x08A5,8,clif->pMoveToKafra,2,4);
	packet(0x0940,6,clif->pTickSend,2);
	//packet(0x094B,8,NULL,0); // CZ_JOIN_BATTLE_FIELD
	packet(0x0953,8,clif->pMoveFromKafra,2,4);
...
// 2017-12-06aRagexeRE
	...
	packet(0x0838,12,clif->pSearchStoreInfoListItemClick,2,6,10);
	packet(0x083C,10,clif->pUseSkillToId,2,4,6);
	packet(0x0867,6,clif->pDropItem,2,4);
	//packet(0x086A,4,NULL,0); // CZ_GANGSI_RANK
	packet(0x086E,18,clif->pPartyBookingRegisterReq,2,4);
	packet(0x0885,6,clif->pTickSend,2);
	packet(0x0888,2,clif->pSearchStoreInfoNextPage,0);
	packet(0x0897,19,clif->pWantToConnection,2,6,10,14,18);
	packet(0x089D,36,clif->pStoragePassword,0);
	packet(0x08A2,26,clif->pPartyInvite2,2);
	packet(0x08A4,8,clif->pMoveFromKafra,2,4);
	packet(0x091D,26,clif->pFriendsListAdd,2);
	packet(0x0923,8,clif->pMoveToKafra,2,4);
	//packet(0x092E,8,NULL,0); // CZ_JOIN_BATTLE_FIELD
	packet(0x0936,5,clif->pChangeDir,2,4);
	packet(0x0942,5,clif->pHomMenu,2,4);
	packet(0x0958,-1,clif->pItemListWindowSelected,2,4,8,12);
	packet(0x0961,6,clif->pTakeItem,2);
	packet(0x096A,6,clif->pGetCharNameRequest,2);
#endif
// 2017-12-13bRagexeRE
#if PACKETVER == 20171213
	packet(0x0202,26,clif->pPartyInvite2,2);
	packet(0x0281,-1,clif->pItemListWindowSelected,2,4,8,12);
	packet(0x035F,6,clif->pTickSend,2);
	packet(0x0360,6,clif->pReqClickBuyingStore,2);
	packet(0x0362,6,clif->pDropItem,2,4);
	//packet(0x0363,8,NULL,0); // CZ_JOIN_BATTLE_FIELD
	packet(0x0364,8,clif->pMoveFromKafra,2,4);
	packet(0x0365,18,clif->pPartyBookingRegisterReq,2,4);
	packet(0x0366,90,clif->pUseSkillToPosMoreInfo,2,4,6,8,10);
	packet(0x0368,6,clif->pSolveCharName,2);
	...
	packet(0x0838,12,clif->pSearchStoreInfoListItemClick,2,6,10);
	packet(0x083C,10,clif->pUseSkillToId,2,4,6);
	packet(0x0860,19,clif->pWantToConnection,2,6,10,14,18);
	//packet(0x0881,4,NULL,0); // CZ_GANGSI_RANK
	packet(0x0890,36,clif->pStoragePassword,0);
	packet(0x091A,5,clif->pChangeDir,2,4);
	packet(0x0957,5,clif->pHomMenu,2,4);
	packet(0x096A,6,clif->pGetCharNameRequest,2);
// 2017-12-20aRagexeRE
#endif
#if PACKETVER == 20171220
	packet(0x0281,19,clif->pWantToConnection,2,6,10,14,18);
	packet(0x0366,8,clif->pMoveFromKafra,2,4);
	packet(0x0369,-1,clif->pSearchStoreInfo,2,4,5,9,13,14,15);
	packet(0x0436,2,clif->pSearchStoreInfoNextPage,0);
	packet(0x0437,18,clif->pPartyBookingRegisterReq,2,4);
	packet(0x085E,-1,clif->pReqOpenBuyingStore,2,4,8,9,89);
	packet(0x0861,-1,clif->pReqTradeBuyingStore,2,4,8,12);
	packet(0x0872,10,clif->pUseSkillToId,2,4,6);
	packet(0x0873,6,clif->pGetCharNameRequest,2);
	packet(0x0880,12,clif->pSearchStoreInfoListItemClick,2,6,10);
	packet(0x0882,6,clif->pTickSend,2);
	packet(0x0885,-1,clif->pItemListWindowSelected,2,4,8,12);
	packet(0x088C,10,clif->pUseSkillToPos,2,4,6,8);
	packet(0x0899,36,clif->pStoragePassword,0);
	packet(0x089E,5,clif->pWalkToXY,2);
	packet(0x08A7,2,clif->pReqCloseBuyingStore,0);
	packet(0x091B,6,clif->pTakeItem,2);
	packet(0x091E,6,clif->pSolveCharName,2);
	packet(0x0924,8,clif->pMoveToKafra,2,4);
	packet(0x0929,6,clif->pDropItem,2,4);
	packet(0x0933,5,clif->pChangeDir,2,4);
	packet(0x093E,7,clif->pActionRequest,2,6);
	packet(0x0941,6,clif->pReqClickBuyingStore,2);
	//packet(0x0946,4,NULL,0); // CZ_GANGSI_RANK
	//packet(0x094E,8,NULL,0); // CZ_JOIN_BATTLE_FIELD
	packet(0x0951,5,clif->pHomMenu,2,4);
	packet(0x0957,26,clif->pFriendsListAdd,2);
	packet(0x0960,90,clif->pUseSkillToPosMoreInfo,2,4,6,8,10);
	packet(0x0964,26,clif->pPartyInvite2,2);
#endif
// 2017-12-27aRagexeRE
#if PACKETVER == 20171227
	packet(0x035F,6,clif->pTickSend,2);
	packet(0x0360,6,clif->pReqClickBuyingStore,2);
	packet(0x0361,7,clif->pActionRequest,2,6);
	packet(0x0366,90,clif->pUseSkillToPosMoreInfo,2,4,6,8,10);
	packet(0x0368,6,clif->pSolveCharName,2);
	packet(0x0369,5,clif->pChangeDir,2,4);
	packet(0x0437,5,clif->pWalkToXY,2);
	packet(0x0438,10,clif->pUseSkillToPos,2,4,6,8);
	...
	packet(0x0838,12,clif->pSearchStoreInfoListItemClick,2,6,10);
	packet(0x083C,10,clif->pUseSkillToId,2,4,6);
	packet(0x087D,36,clif->pStoragePassword,0);
	packet(0x0888,8,clif->pMoveFromKafra,2,4);
	//packet(0x088A,8,NULL,0); // CZ_JOIN_BATTLE_FIELD
	packet(0x088D,6,clif->pTakeItem,2);
	packet(0x08A0,8,clif->pMoveToKafra,2,4);
	packet(0x08A5,5,clif->pHomMenu,2,4);
	packet(0x092C,19,clif->pWantToConnection,2,6,10,14,18);
	//packet(0x092E,4,NULL,0); // CZ_GANGSI_RANK
	packet(0x0938,26,clif->pPartyInvite2,2);
	packet(0x0945,-1,clif->pItemListWindowSelected,2,4,8,12);
	packet(0x0946,26,clif->pFriendsListAdd,2);
	packet(0x0969,6,clif->pDropItem,2,4);
	packet(0x096A,18,clif->pPartyBookingRegisterReq,2,4);
#endif
// 2018-01-03aRagexeRE or 2018-01-03bRagexeRE
#if PACKETVER == 20180103
	packet(0x02C4,8,clif->pMoveToKafra,2,4);
	packet(0x0363,26,clif->pPartyInvite2,2);
	packet(0x0811,19,clif->pWantToConnection,2,6,10,14,18);
	//packet(0x0865,4,NULL,0); // CZ_GANGSI_RANK
	packet(0x086B,-1,clif->pSearchStoreInfo,2,4,5,9,13,14,15);
	packet(0x086D,12,clif->pSearchStoreInfoListItemClick,2,6,10);
	packet(0x0872,6,clif->pReqClickBuyingStore,2);
	packet(0x0876,6,clif->pTickSend,2);
	packet(0x0879,-1,clif->pReqTradeBuyingStore,2,4,8,12);
	packet(0x088E,2,clif->pReqCloseBuyingStore,0);
	packet(0x0899,26,clif->pFriendsListAdd,2);
	packet(0x089F,6,clif->pSolveCharName,2);
	packet(0x08A9,5,clif->pChangeDir,2,4);
	packet(0x08AB,6,clif->pGetCharNameRequest,2);
	packet(0x08AC,-1,clif->pItemListWindowSelected,2,4,8,12);
	packet(0x091D,7,clif->pActionRequest,2,6);
	packet(0x0922,2,clif->pSearchStoreInfoNextPage,0);
	//packet(0x0926,8,NULL,0); // CZ_JOIN_BATTLE_FIELD
	packet(0x0927,18,clif->pPartyBookingRegisterReq,2,4);
	packet(0x092C,8,clif->pMoveFromKafra,2,4);
	packet(0x0935,6,clif->pTakeItem,2);
	packet(0x0938,10,clif->pUseSkillToId,2,4,6);
	packet(0x0941,5,clif->pWalkToXY,2);
	packet(0x0946,36,clif->pStoragePassword,0);
	packet(0x0948,5,clif->pHomMenu,2,4);
	packet(0x094E,-1,clif->pReqOpenBuyingStore,2,4,8,9,89);
	packet(0x095D,10,clif->pUseSkillToPos,2,4,6,8);
	packet(0x095F,6,clif->pDropItem,2,4);
	packet(0x0960,90,clif->pUseSkillToPosMoreInfo,2,4,6,8,10);
#endif
